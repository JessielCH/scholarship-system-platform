...
import { Check, UploadCloud, X, Loader2, FileText } from "lucide-react";
...
export const ContractUploadModal = ({ studentId, onClose, onSuccess }: Props) => {
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b">
          <h3 className="font-bold text-gray-800 flex items-center gap-2">
            <FileText className="text-uce-red" size={20} />
          ...
          {!file ? (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 text-xs text-gray-600 text-center">
                Asegúrate de que la firma sea clara. La IA validará la firma de forma automática.
              </div>
